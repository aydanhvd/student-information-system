...
import logOut from '../assets/icons/light-theme/logout.png';
...
export const ICONS_LIGHT = Object.freeze({
	...
	chatBubbleLight, //feedback icon for drawer
	editLight, //pen icon for settings screen
	heartLight, //like btn
	leftAlignLight, //drawer btn for header screen
	lockLight, //lock icon for auth screen
	menuLight, //home btn icon for footer
	moreLight, //3 dots icon for homeWork scren component
	notebookLight, //class icon for footer
