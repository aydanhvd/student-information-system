      ...
      >
          ...
          {post && (
            <>
              ...
              <View style={styles.postBodyContainer}>
                <CustomText
                  weight="semi"
                  style={{ ...styles.fullName, color: colorTheme.textTheme }}
                >
                  {auther[0]?.name}
                </CustomText>
                <CustomText
                  style={{ ...styles.userName, color: colorTheme.borderTheme }}
                >
                  @{auther[0]?.userName}
                </CustomText>
                <CustomText
                  style={{ ...styles.text, color: colorTheme.textTheme }}
                >
                  {post.text}
                </CustomText>
              </View>
              <CustomText
                style={{ ...styles.time, color: colorTheme.textTheme }}
              >
        ...
        <View
          style={{
            ...
            backgroundColor: colorTheme.borderTheme,
          }}
        >
